...
- [ChildConnect](https://github.com/27July/ChildConnect): A cross-platform mobile application for educators to communicate with parents featuring child tracking, real-time messaging with translation and speech integration, homework/document sharing and attendance management 
