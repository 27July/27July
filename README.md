...
- [Multidisciplinary-Design-Project](https://github.com/27July/SC2079-Multidisciplinary-Design-Project): Developed an autonomous robot system with navigation and visual recognition, utilising an STM32 RTOS-based motor/steering control for reliable movement execution (contributed as part of the STM team)
